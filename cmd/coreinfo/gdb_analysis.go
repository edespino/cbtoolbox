...
func extractCoreSummary(gdbOutput string) (string, error) {
    ...
    // Use regex patterns to extract details from GDB output.
	...
	return "", fmt.Errorf("failed to extract signal information")
    }
	...
	faultAddr = "N/A" // Optional field, use a default value if not found.
    }
	...
	processArgs = "N/A" // Optional field.
    }
